...
import './DeadlineLoader.css';

export default function DeadlineUI() {
  const [actualDay, setActualDay] = useState(7);
  const deadline = 7;
  const animationTime = 4000; // 4s

  useEffect(() => {
    let day = deadline;
    const dayDuration = animationTime / deadline;
      ...
      <div id="deadline">
        <svg preserveAspectRatio="none" id="line" viewBox="0 0 581 158">
          ...
          <g>
            ...
            <rect id="progress-time-fill" x="-100%" y="34" clipPath="url(#SVGID_2_)" fill="#BE002A" width="586" height="103" style={{ animationDuration: '4s' }} />
          </g>
          <g id="death-group" style={{ animationDuration: '4s' }}>
        ...
        <div className="deadline-days">
          <div className="mask-red">
            <div className="inner">
              Deadline <span className="day">{actualDay}</span> <span className="days">days</span>
            </div>
          </div>
