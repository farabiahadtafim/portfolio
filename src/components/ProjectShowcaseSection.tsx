...
const defaultImages = [
  ...
  '/image/projects/3D Carousel work page images/15. 3D Carouse.webp',
  '/image/projects/3D Carousel work page images/16. 3D Carouse.webp',
  '/image/projects/3D Carousel work page images/17. 3D Carouse.webp',
  '/image/projects/3D Carousel work page images/18. 3D Carouse.webp',
  '/image/projects/3D Carousel work page images/19. 3D Carouse.webp',
  '/image/projects/3D Carousel work page images/20. 3D Carouse.webp',
  '/image/projects/3D Carousel work page images/21. 3D Carouse.webp',
  '/image/projects/3D Carousel work page images/22. 3D Carouse.webp',
  '/image/projects/3D Carousel work page images/23. 3D Carouse.webp',
  '/image/projects/3D Carousel work page images/24. 3D Carouse.webp',
  '/image/projects/3D Carousel work page images/25  3D Carouse.webp',
  '/image/projects/3D Carousel work page images/26. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/27. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/28. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/29. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/30. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/31. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/32. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/33. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/34. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/36. 3D Carousel.png',
  '/image/projects/3D Carousel work page images/36. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/37. 3D Carousel.webp',
  '/image/projects/3D Carousel work page images/38. 3D Carousel.webp',
];
...
export default function ProjectShowcaseSection() {
  ...
  useEffect(() => {
    ...
    const radius = 700; // Hardcoded to match the exact size and look of the original 14-image carousel
