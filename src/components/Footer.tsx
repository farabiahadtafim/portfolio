  ...
  return (
    <div className="w-full overflow-hidden select-none mt-10 sm:mt-14 pb-2 text-center">
      <h1
        ...
        className="w-full text-[#ea0044] uppercase whitespace-nowrap tracking-tight transition-[font-weight] duration-75"
      >
        Farabi Ahad Tafim
      </h1>
    </div>
            ...
            <span className="inline-block relative">
              <AnimatePresence mode="wait">
                <motion.span
                  ...
                  className="font-microphone font-normal text-[#ea0044] inline-block tracking-normal lowercase"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 py-8 border-b border-white/[0.08]">
          ...
          <div>
            ...
            <a
              ...
              className="text-base sm:text-lg font-bold text-white hover:text-[#ea0044] transition-colors"
            >
          ...
          <div>
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                ...
                <span className="text-[#ea0044]">→</span>
              </button>
            </div>
          </div>
            ...
            <div className="flex flex-wrap items-center gap-3.5 sm:gap-4">
              {profile.social.whatsapp && (
                <a
                  ...
                  aria-label="WhatsApp"
                  title="WhatsApp"
                  className="text-neutral-400 hover:text-[#ea0044] transition-all duration-200 hover:scale-110 p-1"
                >
